...
export function Wordmark({
  ...
  const slashFontSize = Math.round(size * 1.2);
  ...
  return (
    ...
    >
      <BrandMark size={size} />
      <span
        className="font-display select-none leading-none text-[var(--color-fg-subtle)]"
        style={{ fontSize: `${slashFontSize}px`, marginInline: "1px 4px" }}
        aria-hidden
      >
        /
      </span>
